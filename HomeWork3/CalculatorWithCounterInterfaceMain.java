...
public class CalculatorWithCounterInterfaceMain {
    public static void main(String[] args) {
        ...
        //CalculatorWithCounterInterface calculator =
         //       new CalculatorWithCounterInterface(new CalculatorWithOperator());
        //CalculatorWithCounterInterface calculator =
         //  new CalculatorWithCounterInterface(new CalculatorWithMathCopy());
        CalculatorWithCounterInterface calculator =
